      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 text-sm ${errors.nombre ? 'border-red-500' : ''}`}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 text-sm ${errors.email ? 'border-red-500' : ''}`}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  type="password"
                  placeholder="••••••••"
                  className={`pl-10 text-sm ${errors.password ? 'border-red-500' : ''}`}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  type="password"
                  placeholder="••••••••"
                  className={`pl-10 text-sm ${errors.confirmPassword ? 'border-red-500' : ''}`}
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-4">
            <Button variant="outline" type="button" disabled className="text-xs sm:text-sm">
